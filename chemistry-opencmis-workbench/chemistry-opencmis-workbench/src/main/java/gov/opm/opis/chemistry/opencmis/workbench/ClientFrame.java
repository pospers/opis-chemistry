...
import gov.opm.opis.chemistry.opencmis.workbench.details.DetailsTabs;
import gov.opm.opis.chemistry.opencmis.workbench.icons.ChangeLogIcon;
import gov.opm.opis.chemistry.opencmis.workbench.icons.ConnectIcon;
import gov.opm.opis.chemistry.opencmis.workbench.icons.ConsoleIcon;
import gov.opm.opis.chemistry.opencmis.workbench.icons.CreateObjectIcon;
import gov.opm.opis.chemistry.opencmis.workbench.icons.InfoIcon;
import gov.opm.opis.chemistry.opencmis.workbench.icons.LogIcon;
import gov.opm.opis.chemistry.opencmis.workbench.icons.QueryIcon;
import gov.opm.opis.chemistry.opencmis.workbench.icons.RepositoryInfoIcon;
import gov.opm.opis.chemistry.opencmis.workbench.icons.TckIcon;
import gov.opm.opis.chemistry.opencmis.workbench.icons.TypesIcon;
...
import gov.opm.opis.chemistry.opencmis.workbench.types.TypesFrame;
