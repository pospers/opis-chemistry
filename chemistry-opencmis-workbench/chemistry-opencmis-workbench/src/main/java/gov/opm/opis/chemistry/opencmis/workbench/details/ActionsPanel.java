 ...
 * under the License.
 */
package gov.opm.opis.chemistry.opencmis.workbench.details;
...
import gov.opm.opis.chemistry.opencmis.workbench.WorkbenchScale;
import gov.opm.opis.chemistry.opencmis.workbench.actions.AclUpdatePanel;
import gov.opm.opis.chemistry.opencmis.workbench.actions.AddObjectToFolderPanel;
import gov.opm.opis.chemistry.opencmis.workbench.actions.AppendContentStreamPanel;
import gov.opm.opis.chemistry.opencmis.workbench.actions.ApplyPolicyPanel;
import gov.opm.opis.chemistry.opencmis.workbench.actions.CancelCheckOutPanel;
import gov.opm.opis.chemistry.opencmis.workbench.actions.CheckInPanel;
import gov.opm.opis.chemistry.opencmis.workbench.actions.CheckOutPanel;
import gov.opm.opis.chemistry.opencmis.workbench.actions.CopyPanel;
import gov.opm.opis.chemistry.opencmis.workbench.actions.DeleteContentStreamPanel;
import gov.opm.opis.chemistry.opencmis.workbench.actions.DeletePanel;
import gov.opm.opis.chemistry.opencmis.workbench.actions.DeleteTreePanel;
import gov.opm.opis.chemistry.opencmis.workbench.actions.DownloadPanel;
import gov.opm.opis.chemistry.opencmis.workbench.actions.MovePanel;
import gov.opm.opis.chemistry.opencmis.workbench.actions.PropertyUpdatePanel;
import gov.opm.opis.chemistry.opencmis.workbench.actions.RemoveObjectFromFolderPanel;
import gov.opm.opis.chemistry.opencmis.workbench.actions.RemovePolicyPanel;
import gov.opm.opis.chemistry.opencmis.workbench.actions.SetContentStreamPanel;
import gov.opm.opis.chemistry.opencmis.workbench.model.ClientModel;
import gov.opm.opis.chemistry.opencmis.workbench.model.ClientModelEvent;
import gov.opm.opis.chemistry.opencmis.workbench.model.ObjectListener;
