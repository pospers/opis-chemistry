...
import gov.opm.opis.chemistry.opencmis.workbench.ConsoleHelper;
import gov.opm.opis.chemistry.opencmis.workbench.WorkbenchScale;
import gov.opm.opis.chemistry.opencmis.workbench.checks.ObjectComplianceTestGroup;
...
import gov.opm.opis.chemistry.opencmis.workbench.swing.BaseTypeLabel;
import gov.opm.opis.chemistry.opencmis.workbench.swing.InfoPanel;
import gov.opm.opis.chemistry.opencmis.workbench.worker.LoadObjectWorker;
import gov.opm.opis.chemistry.opencmis.workbench.worker.TempFileContentWorker;
...
public class ObjectPanel extends InfoPanel implements ObjectListener {
    ...
    private String createGroovySourceCode(CmisObject object) {
        ...
        sb.append("import gov.opm.opis.chemistry.opencmis.commons.*\n");
        sb.append("import gov.opm.opis.chemistry.opencmis.commons.data.*\n");
        sb.append("import gov.opm.opis.chemistry.opencmis.commons.enums.*\n");
        sb.append("import gov.opm.opis.chemistry.opencmis.client.api.*\n");
        sb.append("import gov.opm.opis.chemistry.opencmis.client.util.*\n\n");
