 ...
 * under the License.
 */
package gov.opm.opis.chemistry.opencmis.tck.runner;
...
import gov.opm.opis.chemistry.opencmis.tck.report.CoreHtmlReport;
...
public class WebRunnerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        pw.println("<table>");
        pw.println("<tr><td>AtomPub URL:</td><td><input type=\"text\" name=\"gov.opm.opis.chemistry.opencmis.binding.atompub.url\" size=\"50\"></td></tr>");
        pw.println("<tr><td>Username:</td><td><input type=\"text\" name=\"gov.opm.opis.chemistry.opencmis.user\" size=\"50\"></td></tr>");
        pw.println("<tr><td>Password:</td><td><input type=\"password\" name=\"gov.opm.opis.chemistry.opencmis.password\" size=\"50\"></td></tr>");
        pw.println("<tr><td>Repository Id:</td><td><input type=\"text\" name=\"gov.opm.opis.chemistry.opencmis.session.repository.id\" size=\"50\"></td></tr>");
        pw.println("<tr><td></td><td><input type=\"submit\" value=\"Start TCK\"></td></tr>");
        pw.println("<input type=\"hidden\" name=\"gov.opm.opis.chemistry.opencmis.binding.spi.type\" value=\"atompub\">");
        pw.println("</form>");
