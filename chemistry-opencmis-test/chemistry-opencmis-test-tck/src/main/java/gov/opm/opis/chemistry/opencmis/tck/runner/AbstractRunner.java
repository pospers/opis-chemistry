...
import gov.opm.opis.chemistry.opencmis.tck.impl.WrapperCmisTestGroup;
...
public abstract class AbstractRunner {
    ...
    public static final String OVERRIDE_KEY = "gov.opm.opis.chemistry";
    ...
    public static final String TCK_BUILD_TIMESTAMP_PARAMETER = "gov.opm.opis.chemistry.opencmis.tck.timestamp";
    public static final String TCK_REVISION = "/META-INF/tck-revision.txt";
    public static final String TCK_REVISION_PARAMETER = "gov.opm.opis.chemistry.opencmis.tck.revision";
