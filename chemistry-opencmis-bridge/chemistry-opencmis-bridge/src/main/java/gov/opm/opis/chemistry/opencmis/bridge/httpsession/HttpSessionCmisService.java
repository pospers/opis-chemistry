 ...
 * under the License.
 */
package gov.opm.opis.chemistry.opencmis.bridge.httpsession;

import java.util.Map;
import java.util.concurrent.locks.ReentrantReadWriteLock;

import gov.opm.opis.chemistry.opencmis.bridge.CachedBindingCmisService;
...
public abstract class HttpSessionCmisService extends CachedBindingCmisService {
    ...
    public static final String CMIS_BINDING = "gov.opm.opis.chemistry.opencmis.bridge.binding";
