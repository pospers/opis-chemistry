 ...
 * under the License.
 */
package gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub;

import static gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.CmisAtomPubConstants.CONTENT_SRC;
import static gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.CmisAtomPubConstants.LINK_HREF;
import static gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.CmisAtomPubConstants.LINK_REL;
import static gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.CmisAtomPubConstants.LINK_TYPE;
import static gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.CmisAtomPubConstants.TAG_ACL;
import static gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.CmisAtomPubConstants.TAG_ALLOWABLEACTIONS;
import static gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.CmisAtomPubConstants.TAG_CHILDREN;
import static gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.CmisAtomPubConstants.TAG_COLLECTION;
import static gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.CmisAtomPubConstants.TAG_COLLECTION_TYPE;
import static gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.CmisAtomPubConstants.TAG_CONTENT;
import static gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.CmisAtomPubConstants.TAG_ENTRY;
import static gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.CmisAtomPubConstants.TAG_FEED;
import static gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.CmisAtomPubConstants.TAG_HTML;
import static gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.CmisAtomPubConstants.TAG_LINK;
import static gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.CmisAtomPubConstants.TAG_NUM_ITEMS;
import static gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.CmisAtomPubConstants.TAG_OBJECT;
import static gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.CmisAtomPubConstants.TAG_PATH_SEGMENT;
import static gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.CmisAtomPubConstants.TAG_RELATIVE_PATH_SEGMENT;
import static gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.CmisAtomPubConstants.TAG_REPOSITORY_INFO;
import static gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.CmisAtomPubConstants.TAG_SERVICE;
import static gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.CmisAtomPubConstants.TAG_TEMPLATE_TEMPLATE;
import static gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.CmisAtomPubConstants.TAG_TEMPLATE_TYPE;
import static gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.CmisAtomPubConstants.TAG_TYPE;
import static gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.CmisAtomPubConstants.TAG_URI_TEMPLATE;
import static gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.CmisAtomPubConstants.TAG_WORKSPACE;
...
import gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.objects.AtomAcl;
import gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.objects.AtomAllowableActions;
import gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.objects.AtomBase;
import gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.objects.AtomElement;
import gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.objects.AtomEntry;
import gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.objects.AtomFeed;
import gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.objects.AtomLink;
import gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.objects.HtmlDoc;
import gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.objects.RepositoryWorkspace;
import gov.opm.opis.chemistry.opencmis.client.bindings.spi.atompub.objects.ServiceDoc;
...
import gov.opm.opis.chemistry.opencmis.commons.impl.XMLConstants;
import gov.opm.opis.chemistry.opencmis.commons.impl.XMLConstraints;
import gov.opm.opis.chemistry.opencmis.commons.impl.XMLConverter;
import gov.opm.opis.chemistry.opencmis.commons.impl.XMLUtils;
