...
import gov.opm.opis.chemistry.opencmis.client.bindings.spi.AbstractAuthenticationProvider;
...
public class OkHttpHttpInvoker implements HttpInvoker {
    ...
    protected static final String HTTP_CLIENT = "gov.opm.opis.chemistry.opencmis.client.bindings.spi.http.OkHttpHttpInvoker.httpClient";
