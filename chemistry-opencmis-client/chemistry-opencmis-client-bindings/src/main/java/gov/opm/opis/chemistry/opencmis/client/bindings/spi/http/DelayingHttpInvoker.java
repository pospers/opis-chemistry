...
public class DelayingHttpInvoker implements HttpInvoker {
     ...
     */
    public static final String DELEGTAE_HTTP_INVOKER_CLASS = "gov.opm.opis.chemistry.opencmis.binding.httpinvoker.delay.delegate.classname";
    /**
     * Session parameter: Delay time in milliseconds. (Required.)
     */
    public static final String DELAY_TIME = "gov.opm.opis.chemistry.opencmis.binding.httpinvoker.delay.delaytime";

    protected static final String DELEGTAE_HTTP_INVOKER = "gov.opm.opis.chemistry.opencmis.client.bindings.spi.http.limiter.httpInvoker";
    protected static final String LAST_EXECUTION = "gov.opm.opis.chemistry.opencmis.client.bindings.spi.http.limiter.lastExecution";
