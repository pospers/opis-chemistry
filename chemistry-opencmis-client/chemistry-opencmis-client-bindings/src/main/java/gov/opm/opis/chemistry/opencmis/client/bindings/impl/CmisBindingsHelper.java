 ...
 * under the License.
 */
package gov.opm.opis.chemistry.opencmis.client.bindings.impl;
...
public final class CmisBindingsHelper {
    ...
    public static final String REPOSITORY_INFO_CACHE = "gov.opm.opis.chemistry.opencmis.binding.repositoryInfoCache";
    public static final String TYPE_DEFINTION_CACHE = "gov.opm.opis.chemistry.opencmis.binding.typeDefintionCache";
    public static final String SPI_OBJECT = "gov.opm.opis.chemistry.opencmis.binding.spi.object";
    public static final String HTTP_INVOKER_OBJECT = "gov.opm.opis.chemistry.opencmis.binding.httpinvoker.object";
    public static final String AUTHENTICATION_PROVIDER_OBJECT = "gov.opm.opis.chemistry.opencmis.binding.auth.object";
    public static final String ACCEPT_LANGUAGE = "gov.opm.opis.chemistry.opencmis.binding.acceptLanguage";
