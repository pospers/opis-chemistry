 ...
 * under the License.
 */
package gov.opm.opis.chemistry.opencmis.client.bindings.cache;

import gov.opm.opis.chemistry.opencmis.client.bindings.cache.Cache;
import gov.opm.opis.chemistry.opencmis.client.bindings.cache.impl.CacheImpl;
import gov.opm.opis.chemistry.opencmis.client.bindings.cache.impl.ContentTypeCacheLevelImpl;
import gov.opm.opis.chemistry.opencmis.client.bindings.cache.impl.LruCacheLevelImpl;
import gov.opm.opis.chemistry.opencmis.client.bindings.cache.impl.MapCacheLevelImpl;
...
public class CacheTest extends TestCase {
    ...
    public static final String MAP_CACHE_LEVEL = "gov.opm.opis.chemistry.opencmis.client.bindings.cache.impl.MapCacheLevelImpl";
    public static final String LRU_CACHE_LEVEL = "gov.opm.opis.chemistry.opencmis.client.bindings.cache.impl.LruCacheLevelImpl";
    ...
    public void testCacheConfig() {
        ...
        try {
            cache = new CacheImpl();
            cache.initialize(new String[] { "gov.opm.opis.chemistry.opencmis.client.provider.cache.CacheTest" });
        } catch (IllegalArgumentException e) {
        }
    }
