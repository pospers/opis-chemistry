...
import gov.opm.opis.chemistry.opencmis.client.SessionFactoryFinder;
import gov.opm.opis.chemistry.opencmis.client.api.Repository;
...
import gov.opm.opis.chemistry.opencmis.commons.endpoints.CmisAuthentication;
...
public class SessionFactoryFinderTest {
    ...
    public void testFindWithProperty1() throws ClassNotFoundException, InstantiationException {
        System.setProperty("gov.opm.opis.chemistry.test.sessionfactory1", MockSessionFactory1.class.getName());

        SessionFactory sf = SessionFactoryFinder.find("gov.opm.opis.chemistry.test.sessionfactory1");
    ...
    public void testFindWithProperty2() throws ClassNotFoundException, InstantiationException {
        System.setProperty("gov.opm.opis.chemistry.test.sessionfactory2", SessionFactoryFinderTest.class.getName());

        SessionFactoryFinder.find("gov.opm.opis.chemistry.test.sessionfactory2");
    }

    @Test()
    public void testFindWithProperty3() throws ClassNotFoundException, InstantiationException {
        System.setProperty("gov.opm.opis.chemistry.test.sessionfactory3", MockSessionFactory2.class.getName());

        SessionFactory sf = SessionFactoryFinder.find("gov.opm.opis.chemistry.test.sessionfactory3");
