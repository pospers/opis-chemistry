...
public final class XMLConstraints {
    ...
    public static final String MAX_EXTENSIONS_WIDTH_SYSTEM_PROPERTY = "gov.opm.opis.chemistry.opencmis.XMLConstraints.maxExtensionWith";
    public static final String MAX_EXTENSIONS_DEPTH_SYSTEM_PROPERTY = "gov.opm.opis.chemistry.opencmis.XMLConstraints.maxExtensionDepth";
