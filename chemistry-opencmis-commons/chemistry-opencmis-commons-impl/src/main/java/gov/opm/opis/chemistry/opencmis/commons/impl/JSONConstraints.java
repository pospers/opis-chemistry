...
public class JSONConstraints {
    ...
    public static final String MAX_OBJECT_SIZE_SYSTEM_PROPERTY = "gov.opm.opis.chemistry.opencmis.JSONConstraints.maxObjectSize";
    public static final String MAX_ARRAY_SIZE_SYSTEM_PROPERTY = "gov.opm.opis.chemistry.opencmis.JSONConstraints.maxArraySize";
    public static final String MAX_DEPTH_SYSTEM_PROPERTY = "gov.opm.opis.chemistry.opencmis.JSONConstraints.maxDepth";
