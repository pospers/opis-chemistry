...
import gov.opm.opis.chemistry.opencmis.commons.data.MutableAce;
import gov.opm.opis.chemistry.opencmis.commons.data.MutableAcl;
import gov.opm.opis.chemistry.opencmis.commons.data.MutableContentStream;
import gov.opm.opis.chemistry.opencmis.commons.data.MutableProperties;
import gov.opm.opis.chemistry.opencmis.commons.data.MutablePropertyBoolean;
import gov.opm.opis.chemistry.opencmis.commons.data.MutablePropertyData;
import gov.opm.opis.chemistry.opencmis.commons.data.MutablePropertyDateTime;
import gov.opm.opis.chemistry.opencmis.commons.data.MutablePropertyDecimal;
import gov.opm.opis.chemistry.opencmis.commons.data.MutablePropertyHtml;
import gov.opm.opis.chemistry.opencmis.commons.data.MutablePropertyId;
import gov.opm.opis.chemistry.opencmis.commons.data.MutablePropertyInteger;
import gov.opm.opis.chemistry.opencmis.commons.data.MutablePropertyString;
import gov.opm.opis.chemistry.opencmis.commons.data.MutablePropertyUri;
