 ...
 * under the License.
 */
package gov.opm.opis.chemistry.opencmis.commons.impl.json;
...
public final class JSONValue {
     ...
     * 
     * @see gov.opm.opis.chemistry.opencmis.commons.impl.json.parser.JSONParser#parse(Reader)
     ...
     * 
     * @see gov.opm.opis.chemistry.opencmis.commons.impl.json.parser.JSONParser
     * 
     * @param in
     * @return Instance of the following: JSONObject, JSONArray,
     *         java.lang.String, java.lang.Number, java.lang.Boolean, null
     ...
     * 
     * @see gov.opm.opis.chemistry.opencmis.commons.impl.json.JSONObject#writeJSONString(Map,
     *      Writer)
     * @see gov.opm.opis.chemistry.opencmis.commons.impl.json.JSONArray#writeJSONString(List,
     *      Writer)
     * 
     * @param value
     * @param out
     ...
     * 
     * @see gov.opm.opis.chemistry.opencmis.commons.impl.json.JSONObject#toJSONString(Map)
     * @see gov.opm.opis.chemistry.opencmis.commons.impl.json.JSONArray#toJSONString(List)
     * 
     * @param value
