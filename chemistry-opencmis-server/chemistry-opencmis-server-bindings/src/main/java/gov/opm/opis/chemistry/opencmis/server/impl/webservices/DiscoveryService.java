 ...
 */
@MTOM
@WebService(endpointInterface = "gov.opm.opis.chemistry.opencmis.commons.impl.jaxb.DiscoveryServicePort")
public class DiscoveryService extends AbstractService implements DiscoveryServicePort {
    ...
    public void getContentChanges(String repositoryId, Holder<String> changeLogToken, Boolean includeProperties,
        ...
        try {
            ...
            gov.opm.opis.chemistry.opencmis.commons.spi.Holder<String> changeLogTokenHolder = convertHolder(changeLogToken);
