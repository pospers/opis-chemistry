 ...
 * under the License.
 */
package gov.opm.opis.chemistry.opencmis.server.impl.browser;

import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.CMISACTION_ADD_OBJECT_TO_FOLDER;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.CMISACTION_APPEND_CONTENT;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.CMISACTION_APPLY_ACL;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.CMISACTION_APPLY_POLICY;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.CMISACTION_BULK_UPDATE;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.CMISACTION_CANCEL_CHECK_OUT;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.CMISACTION_CHECK_IN;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.CMISACTION_CHECK_OUT;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.CMISACTION_CREATE_DOCUMENT;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.CMISACTION_CREATE_DOCUMENT_FROM_SOURCE;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.CMISACTION_CREATE_FOLDER;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.CMISACTION_CREATE_ITEM;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.CMISACTION_CREATE_POLICY;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.CMISACTION_CREATE_RELATIONSHIP;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.CMISACTION_CREATE_TYPE;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.CMISACTION_DELETE;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.CMISACTION_DELETE_CONTENT;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.CMISACTION_DELETE_TREE;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.CMISACTION_DELETE_TYPE;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.CMISACTION_MOVE;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.CMISACTION_QUERY;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.CMISACTION_REMOVE_OBJECT_FROM_FOLDER;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.CMISACTION_REMOVE_POLICY;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.CMISACTION_SET_CONTENT;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.CMISACTION_UPDATE_PROPERTIES;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.CMISACTION_UPDATE_TYPE;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.PARAM_OBJECT_ID;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.SELECTOR_ACL;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.SELECTOR_ALLOWABLEACTIONS;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.SELECTOR_CHECKEDOUT;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.SELECTOR_CHILDREN;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.SELECTOR_CONTENT;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.SELECTOR_CONTENT_CHANGES;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.SELECTOR_DESCENDANTS;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.SELECTOR_FOLDER_TREE;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.SELECTOR_LAST_RESULT;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.SELECTOR_OBJECT;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.SELECTOR_PARENT;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.SELECTOR_PARENTS;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.SELECTOR_POLICIES;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.SELECTOR_PROPERTIES;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.SELECTOR_QUERY;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.SELECTOR_RELATIONSHIPS;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.SELECTOR_RENDITIONS;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.SELECTOR_REPOSITORY_INFO;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.SELECTOR_TYPE_CHILDREN;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.SELECTOR_TYPE_DEFINITION;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.SELECTOR_TYPE_DESCENDANTS;
import static gov.opm.opis.chemistry.opencmis.commons.impl.Constants.SELECTOR_VERSIONS;
import static gov.opm.opis.chemistry.opencmis.commons.impl.JSONConstants.ERROR_EXCEPTION;
import static gov.opm.opis.chemistry.opencmis.commons.impl.JSONConstants.ERROR_MESSAGE;
import static gov.opm.opis.chemistry.opencmis.commons.impl.JSONConstants.ERROR_STACKTRACE;
import static gov.opm.opis.chemistry.opencmis.server.shared.Dispatcher.METHOD_GET;
import static gov.opm.opis.chemistry.opencmis.server.shared.Dispatcher.METHOD_HEAD;
import static gov.opm.opis.chemistry.opencmis.server.shared.Dispatcher.METHOD_POST;
...
import gov.opm.opis.chemistry.opencmis.commons.exceptions.CmisBaseException;
import gov.opm.opis.chemistry.opencmis.commons.exceptions.CmisConstraintException;
import gov.opm.opis.chemistry.opencmis.commons.exceptions.CmisContentAlreadyExistsException;
import gov.opm.opis.chemistry.opencmis.commons.exceptions.CmisFilterNotValidException;
import gov.opm.opis.chemistry.opencmis.commons.exceptions.CmisInvalidArgumentException;
import gov.opm.opis.chemistry.opencmis.commons.exceptions.CmisNameConstraintViolationException;
...
import gov.opm.opis.chemistry.opencmis.commons.exceptions.CmisPermissionDeniedException;
...
import gov.opm.opis.chemistry.opencmis.commons.exceptions.CmisStorageException;
import gov.opm.opis.chemistry.opencmis.commons.exceptions.CmisStreamNotSupportedException;
import gov.opm.opis.chemistry.opencmis.commons.exceptions.CmisTooManyRequestsException;
import gov.opm.opis.chemistry.opencmis.commons.exceptions.CmisUnauthorizedException;
import gov.opm.opis.chemistry.opencmis.commons.exceptions.CmisUpdateConflictException;
import gov.opm.opis.chemistry.opencmis.commons.exceptions.CmisVersioningException;
import gov.opm.opis.chemistry.opencmis.commons.impl.Constants;
import gov.opm.opis.chemistry.opencmis.commons.impl.IOUtils;
import gov.opm.opis.chemistry.opencmis.commons.impl.json.JSONObject;
...
import gov.opm.opis.chemistry.opencmis.server.impl.ServerVersion;
import gov.opm.opis.chemistry.opencmis.server.impl.browser.token.TokenHandler;
...
import gov.opm.opis.chemistry.opencmis.server.shared.ExceptionHelper;
import gov.opm.opis.chemistry.opencmis.server.shared.HEADHttpServletRequestWrapper;
import gov.opm.opis.chemistry.opencmis.server.shared.HttpUtils;
import gov.opm.opis.chemistry.opencmis.server.shared.NoBodyHttpServletResponseWrapper;
import gov.opm.opis.chemistry.opencmis.server.shared.QueryStringHttpServletRequestWrapper;
import gov.opm.opis.chemistry.opencmis.server.shared.ServiceCall;
import gov.opm.opis.chemistry.opencmis.server.shared.TempStoreOutputStreamFactory;
