...
import static gov.opm.opis.chemistry.opencmis.commons.impl.WSConverter.closeStream;
...
import static gov.opm.opis.chemistry.opencmis.commons.impl.WSConverter.convertHolder;
import static gov.opm.opis.chemistry.opencmis.commons.impl.WSConverter.setExtensionValues;
import static gov.opm.opis.chemistry.opencmis.commons.impl.WSConverter.setHolderValue;
...
import gov.opm.opis.chemistry.opencmis.commons.impl.jaxb.EnumUnfileObject;
import gov.opm.opis.chemistry.opencmis.commons.impl.jaxb.EnumVersioningState;
import gov.opm.opis.chemistry.opencmis.commons.impl.jaxb.ObjectServicePort;
import gov.opm.opis.chemistry.opencmis.commons.impl.jaxb.DeleteTreeResponse.FailedToDelete;
 ...
 */
@MTOM
@WebService(endpointInterface = "gov.opm.opis.chemistry.opencmis.commons.impl.jaxb.ObjectServicePort")
public class ObjectService extends AbstractService implements ObjectServicePort {
    ...
    public void deleteContentStream(String repositoryId, Holder<String> objectId, Holder<String> changeToken,
        ...
        try {
            ...
            gov.opm.opis.chemistry.opencmis.commons.spi.Holder<String> objectIdHolder = convertHolder(objectId);
            gov.opm.opis.chemistry.opencmis.commons.spi.Holder<String> changeTokenHolder = convertHolder(changeToken);
            ExtensionsData extData = convertExtensionHolder(extension);
