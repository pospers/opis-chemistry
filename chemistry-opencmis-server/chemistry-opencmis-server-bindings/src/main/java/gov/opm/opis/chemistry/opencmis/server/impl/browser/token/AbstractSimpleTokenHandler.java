...
import gov.opm.opis.chemistry.opencmis.server.impl.browser.AbstractBrowserServiceCall;
...
public abstract class AbstractSimpleTokenHandler implements TokenHandler, Serializable {
    ...
    private static final String ATTR_PREFIX = "gov.opm.opis.chemistry.opencmis.";
