 ...
 */
@MTOM
@WebService(endpointInterface = "gov.opm.opis.chemistry.opencmis.commons.impl.jaxb.VersioningServicePort")
public class VersioningService extends AbstractService implements VersioningServicePort {
    ...
    public void checkOut(String repositoryId, Holder<String> objectId, Holder<CmisExtensionType> extension,
        ...
        try {
            ...
            gov.opm.opis.chemistry.opencmis.commons.spi.Holder<String> objectIdHolder = convertHolder(objectId);
            gov.opm.opis.chemistry.opencmis.commons.spi.Holder<Boolean> contentCopiedHolder = new gov.opm.opis.chemistry.opencmis.commons.spi.Holder<Boolean>();
            ExtensionsData extData = convertExtensionHolder(extension);
