...
public class CmisRepositoryContextListener implements ServletContextListener {
    ...
    public static final String SERVICES_FACTORY = "gov.opm.opis.chemistry.opencmis.servicesfactory";

    private static final Logger LOG = LoggerFactory.getLogger(CmisRepositoryContextListener.class.getName());

    private static final String CONFIG_INIT_PARAM = "gov.opm.opis.chemistry.opencmis.REPOSITORY_CONFIG_FILE";
