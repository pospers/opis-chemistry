 ...
 * under the License.
 */
package gov.opm.opis.chemistry.opencmis.inmemory;
...
import gov.opm.opis.chemistry.opencmis.commons.definitions.MutableFolderTypeDefinition;
import gov.opm.opis.chemistry.opencmis.commons.definitions.MutableItemTypeDefinition;
import gov.opm.opis.chemistry.opencmis.commons.definitions.MutablePolicyTypeDefinition;
import gov.opm.opis.chemistry.opencmis.commons.definitions.MutableRelationshipTypeDefinition;
import gov.opm.opis.chemistry.opencmis.commons.definitions.MutableSecondaryTypeDefinition;
...
import gov.opm.opis.chemistry.opencmis.inmemory.ConfigConstants;
import gov.opm.opis.chemistry.opencmis.inmemory.TypeCreator;
import gov.opm.opis.chemistry.opencmis.inmemory.content.ObjectGenerator;
import gov.opm.opis.chemistry.opencmis.inmemory.storedobj.impl.ContentStreamDataImpl;
import gov.opm.opis.chemistry.opencmis.inmemory.storedobj.impl.RenditionUtil;
import gov.opm.opis.chemistry.opencmis.inmemory.types.DocumentTypeCreationHelper;
import gov.opm.opis.chemistry.opencmis.inmemory.types.PropertyCreationHelper;
import gov.opm.opis.chemistry.opencmis.server.support.TypeDefinitionFactory;
