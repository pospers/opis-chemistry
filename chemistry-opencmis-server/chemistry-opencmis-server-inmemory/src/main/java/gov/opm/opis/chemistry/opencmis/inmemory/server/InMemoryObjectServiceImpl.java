...
import gov.opm.opis.chemistry.opencmis.inmemory.FilterParser;
import gov.opm.opis.chemistry.opencmis.inmemory.NameValidator;
import gov.opm.opis.chemistry.opencmis.inmemory.storedobj.api.Content;
import gov.opm.opis.chemistry.opencmis.inmemory.storedobj.api.Document;
...
import gov.opm.opis.chemistry.opencmis.server.support.TypeValidator;
...
public class InMemoryObjectServiceImpl extends InMemoryAbstractServiceImpl {
    ...
    private StoredObject createDocumentIntern(CallContext context, String repositoryId, Properties properties,
        ...
        Acl aclAdd = gov.opm.opis.chemistry.opencmis.inmemory.TypeValidator.expandAclMakros(context.getUsername(),
                addACEs);
        Acl aclRemove = gov.opm.opis.chemistry.opencmis.inmemory.TypeValidator.expandAclMakros(context.getUsername(),
                removeACEs);
    ...
    private StoredObject createPolicyIntern(CallContext context, String repositoryId, Properties properties,
        ...
        aclAdd = gov.opm.opis.chemistry.opencmis.inmemory.TypeValidator.expandAclMakros(context.getUsername(), aclAdd);
        aclRemove = gov.opm.opis.chemistry.opencmis.inmemory.TypeValidator.expandAclMakros(context.getUsername(),
                aclRemove);
